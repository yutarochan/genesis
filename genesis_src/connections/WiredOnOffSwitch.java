...
/*  8:   */ 
/*  9:   */ public class WiredOnOffSwitch
/* 10:   */   extends JCheckBox
...
/* 16:   */   
/* 17:   */   public WiredOnOffSwitch(String name, AtomicBoolean atomicBoolean)
/* 18:   */   {
...
/* 28:   */   }
/* 29:   */   
/* 30:   */   public WiredOnOffSwitch(String name)
/* 31:   */   {
/* 32:35 */     this(name, false);
/* 33:   */   }
/* 34:   */   
/* 35:   */   public WiredOnOffSwitch(String name, boolean state)
/* 36:   */   {
/* 37:39 */     super(name);
/* 38:40 */     setName(name);
...
/* 52:   */   {
/* 53:   */     WiredOnOffSwitch button;
/* 54:   */     
/* 55:   */     public MyPropertyChangeListener(WiredOnOffSwitch button)
/* 56:   */     {
...
/* 63:61 */       Preferences.userRoot().putBoolean(WiredOnOffSwitch.key + name, this.button.isSelected());
/* 64:62 */       if (WiredOnOffSwitch.this.trackingValue != null) {
/* 65:63 */         WiredOnOffSwitch.this.trackingValue.set(this.button.isSelected());
/* 66:   */       }
/* 67:   */     }
/* 68:   */   }
/* 69:   */   
 ...
 * Qualified Name:     connections.WiredOnOffSwitch
