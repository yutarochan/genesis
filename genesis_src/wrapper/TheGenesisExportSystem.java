...
/*  20:    */ 
/*  21:    */ public class TheGenesisExportSystem
/*  22:    */   extends ABasicFrame
/*  23:    */ {
/*  24:    */   public TheGenesisExportSystem(String[] args)
/*  25:    */   {
/*  26: 26 */     super(args, TheGenesisExportSystem.class.getResource("genesisexport.xml"));
...
/* 104:100 */         TheGenesisExportSystem.this.setToVideoRecordingDimensions(new Rectangle(0, 0, 1024, 768));
/* 105:102 */       } else if (e.getSource() == Genesis.makeMediumVideoRecordingButton) {
/* 106:103 */         TheGenesisExportSystem.this.setToVideoRecordingDimensions(new Rectangle(0, 0, 1280, 1024));
/* 107:105 */       } else if (e.getSource() == Genesis.makeLargeVideoRecordingButton) {
/* 108:106 */         TheGenesisExportSystem.this.setToVideoRecordingDimensions(new Rectangle(0, 0, 1600, 1200));
/* 109:    */       }
/* 110:    */     }
/* 111:    */   }
/* 112:    */   
...
/* 124:    */ 
/* 125:    */ 
/* 126:123 */       new Object[] { System.getProperty("os.name") });Mark.say(new Object[] { System.getProperty("os.arch") });new TheGenesisExportSystem(args).start();
/* 127:    */   }
/* 128:    */ }


/* Location:           C:\Yuya\Development\Genesis\genesis.jar
 * Qualified Name:     wrapper.TheGenesisExportSystem
